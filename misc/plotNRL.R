...
plot_approx<-function(df, sampleID, subtitle, sample_info, peaks_tweek, wd, output, ylim, xlim, span, win) {
  ...
  g <- g + geom_text(x = 2, y = (8*max(reg.df$y)/10), hjust=0, label = reg.equation, parse = TRUE, size=6) 
  g1 = ggplotGrob(g)
...
option_list = list(
  make_option("--input", type="character", default=NULL, 
              help="Nucleosome repeat length file name", metavar="character"),
  ...
  make_option("--info", type="character", default=NULL, 
              help="Sample description", metavar="character"),
  ...
  make_option("--maxX", type="integer", default=1000, 
              help="X-axis maximum [default= %default]", metavar="NR"),
  make_option("--maxY", type="integer", default=10000, 
              help="Y-axis maximum [default= %default]", metavar="NR"),
  make_option("--minY", type="integer", default=1000, 
              help="Y-axis minimum [default= %default]", metavar="NR"),
  ...
  make_option("--peakW", type="integer", default=20, 
              help="peak width [default= %default]", metavar="NR")
); 
